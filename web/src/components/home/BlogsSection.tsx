                ...
                >
                  <defs>
                    <linearGradient id={`gradient-${index}`} x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor={index % 3 === 0 ? "#21409a" : index % 3 === 1 ? "#51b747" : "#1a3173"} />
                      <stop offset="100%" stopColor={index % 3 === 0 ? "#16285b" : index % 3 === 1 ? "#3f9e35" : "#14265a"} />
                    </linearGradient>
                  </defs>
                  <rect width="800" height="480" fill={`url(#gradient-${index})`} />
                  <circle cx="680" cy="90" r="60" fill="#fff" opacity="0.15" />
                  <path d="M0 480 L0 360 L220 260 L420 380 L640 280 L800 360 L800 480Z" fill="#fff" opacity="0.14" />
                </svg>
                <div className="absolute top-4 left-4 px-3 py-1.5 rounded-md bg-white/20 backdrop-blur-sm text-white text-xs font-mono">
                  {blog.date}
                </div>
              </div>
              <div className="p-6">
