...
const popular = [
  { day: "21", month: "Ashar", title: "Entrance Examination Schedule - 2083", href: "/assets/pdf/entrance-schedule-2083.pdf", views: "3.2k views" },
  { day: "18", month: "Ashar", title: "Admission Form Deadline", href: "/assets/pdf/admission-open-2083.pdf", views: "2.8k views" },
  { day: "10", month: "Ashar", title: "Scholarship Applications Open", href: "/assets/pdf/scholarship-open-2083.pdf", views: "2.1k views" },
  { day: "02", month: "Ashar", title: "Semester Result Publication", href: "/assets/pdf/semester-result-publication.pdf", views: "1.9k views" },
  { day: "28", month: "Jestha", title: "Annual Fest 2083 Dates Announced", href: "/assets/pdf/annual-fest-2083.pdf", views: "1.3k views" },
];
      ...
      <main id="main">
        <section className="page-hero">
          ...
          <div className="wrap-wide page-hero__inner">
            <nav className="crumbs" aria-label="Breadcrumb"><Link href="/">Home</Link> <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg> <span>Notices</span></nav>
            <h1>Notices</h1>
            <p>Official announcements from the administration — admissions, exams, results and events.</p>
          </div>
        </section>

        <section className="section">
          <div className="wrap-wide" style={{ maxWidth: 900 }}>
            <div className="section-head reveal"><span className="eyebrow">Announcements</span><h2 className="section-title">Latest notices</h2></div>
            <div className="tabs reveal">
              ...
              <div className={`tabs__panel${tab === "latest" ? " active" : ""}`}>
                  <div className="page-tools">
                    <label className="page-tools__search">
                      ...
                      <input type="search" placeholder="Search notices..." aria-label="Search notices..." value={query}
                        onChange={(e) => { setQuery(e.target.value); setPage(1); }} />
                    </label>
                    <select className="page-tools__select" aria-label="Filter by category" value={cat}
                    ...
                    <span className="page-tools__count">{filtered.length} of {notices.length} shown</span>
                  </div>

                  <div className="notice-list" style={{ marginTop: "1.25rem" }}>
                    {visible.map((n, i) => (
                      <article key={n.title} className="card notice-item reveal is-inview" style={{ transitionDelay: `${i * 50}ms` }}>
              ...
              <div className={`tabs__panel${tab === "popular" ? " active" : ""}`}>
                <div className="notice-list">
                  <div className="notice-list__head"><h3>Most viewed notices</h3></div>
                  {popular.map((p) => (
            ...
            <div className="card" style={{ marginTop: "2rem", padding: "2rem", textAlign: "center" }}>
              ...
              <p style={{ color: "var(--muted)", margin: ".5rem 0 1.2rem" }}>Subscribe to receive admission and exam updates directly.</p>
              <Link className="btn btn-primary" href="/contact">Contact the Administration <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg></Link>
            </div>
          </div>
        </section>
        ...
        <section className="cta-section"><div className="wrap-wide"><div className="cta-band reveal">
          <div className="cta-band__inner">
            ...
            <div className="cta-band__actions">
              <Link className="btn btn-gold btn-lg" href="/admission">Apply Now <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg></Link>
