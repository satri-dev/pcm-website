...
interface LeadershipMessageManagerProps {
    ...
    <main className="p-6">
      <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
        <div>
          ...
          <p className="mt-1 mb-0 text-[0.9rem] text-[var(--admin-muted)]">Manage messages from Chairman, Principal, and Director.</p>
        </div>
      ...
      <div className="admin-panel">
        <div className="admin-panel__body p-0">
          {error ? (
            ...
            <LeadershipMessageTable messages={messages} onAdd={handleAdd} onView={handleView} onEdit={handleEdit} onDelete={handleDelete} />
          )}
        </div>
      </div>
