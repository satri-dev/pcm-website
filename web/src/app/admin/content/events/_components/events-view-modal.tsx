...
import { CalendarDays, Eye, MapPin, Users, X } from "lucide-react";
...
export default function EventsViewModal({
  open,
  onOpenChange,
  event,
  ...
  const statusBadge = event.status === "published" ? "green" : "gold";
      ...
      >
        ...
        <div className="modal__body">
          ...
          <div className="flex items-center gap-2 flex-wrap mb-2">
            <span className={`badge badge--${typeBadgeColor(event.type)}`}>
              {event.type}
            </span>
