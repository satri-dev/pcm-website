  ...
  return (
    <div className="p-6">
      ...
      <HardDeleteDialog
        ...
        title={`Permanently Delete ${selectedIds.size} Item${selectedIds.size === 1 ? "" : "s"}?`}
        description={`Are you sure you want to permanently delete ${selectedIds.size} item${selectedIds.size === 1 ? "" : "s"}? This action cannot be undone.`}
        confirmText={`Delete ${selectedIds.size} Item${selectedIds.size === 1 ? "" : "s"} Permanently`}
