    ...
    <div>
      ...
      <div className="flex items-center gap-3 p-5 border-b border-[var(--admin-line)] flex-wrap">
        <div className="relative flex-1 min-w-[250px]">
          ...
          <Input
            type="text"
            placeholder="Search by name, program or role..."
            value={searchQuery}
                ...
                >
                  ...
                  <TableCell className="py-3">
                    <Select
                      value={item.status}
                      onValueChange={(value) =>
                        onStatusChange(item.id, value as TestimonialStatus)
                      }
                    >
                      <SelectTrigger className="h-8 w-36">
                        <span
                          className={`badge badge--${STATUS_CLASS[item.status]} lowercase mr-1`}
                        >
